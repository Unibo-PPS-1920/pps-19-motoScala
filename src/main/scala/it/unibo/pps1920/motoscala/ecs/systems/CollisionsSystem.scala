  ...
  private class CollisionsSystemImpl(coordinator: Coordinator, fps: Int)
    ...
    override def update(): Unit = {
      ...
      entitiesRef().foreach(e1=> {
        entitiesToCheck -= e1
        val collisionCompE1 = extractComponent[CollisionComponent](e1,CollisionComponent.getClass)
    ...
    private def isTouching(e1 : Entity, e2 : Entity): Boolean ={
      val e1ShapeC = extractComponent[ShapeComponent](e1, ShapeComponent.getClass)
      val e2ShapeC = extractComponent[ShapeComponent](e2, ShapeComponent.getClass)
      val e1PosC = extractComponent[PositionComponent](e1, PositionComponent.getClass)
      val e2PosC = extractComponent[PositionComponent](e2, PositionComponent.getClass)
    ...
    private def collide(e1:Entity, e2:Entity): Unit ={
      import it.unibo.pps1920.motoscala.ecs.util.Vector2
      val collisionCompE1 = extractComponent[CollisionComponent](e1, CollisionComponent.getClass)
      val collisionCompE2 = extractComponent[CollisionComponent](e2, CollisionComponent.getClass)
      val velocityCompE1 = extractComponent[VelocityComponent](e1, VelocityComponent.getClass)
      val velocityCompE2 = extractComponent[VelocityComponent](e2, VelocityComponent.getClass)
      val positionCompE1 = extractComponent[PositionComponent](e1, PositionComponent.getClass)
      val positionCompE2 = extractComponent[PositionComponent](e2, PositionComponent.getClass)
