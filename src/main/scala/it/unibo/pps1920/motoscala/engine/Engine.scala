...
import it.unibo.pps1920.motoscala.ecs.systems.CollisionsSystem
      ...
      level.entities.foreach {
        ...
        case Player(position, shape, direction, velocity) => {
          ...
          coordinator.addEntity(player)
            ...
            .addEntityComponent(player, CollisionComponent(4, false, 0,Vector2(0,0)))
        }
        ...
        case BlackPupa(position, shape, direction, velocity) => {
          ...
          .addEntityComponent(black, PositionComponent(util.Vector2(position.x, position.y)))
          .addEntityComponent(black, VelocityComponent( Vector2(0, 0), util.Vector2(velocity.x, velocity.y)))
          .addEntityComponent(black, CollisionComponent(4, false, 0,Vector2(0,0)))
        }
        case RedPupa(position, shape, direction, velocity) => {
          ...
          .addEntityComponent(red, PositionComponent(util.Vector2(position.x, position.y)))
          .addEntityComponent(red, VelocityComponent(Vector2(0, 0), util.Vector2(velocity.x, velocity.y)))
          .addEntityComponent(red, CollisionComponent(4, false, 0,Vector2(0,0)))
        }
        case BluePupa(position, shape, direction, velocity) => {
          ...
          .addEntityComponent(blue, PositionComponent(util.Vector2(position.x, position.y)))
          .addEntityComponent(blue, VelocityComponent(Vector2(0, 0), util.Vector2(velocity.x, velocity.y)))
          .addEntityComponent(blue, CollisionComponent(4, false, 0,Vector2(0,0)))
        }
        case Polar(position, shape, direction, velocity) => {
          ...
          .addEntityComponent(polar, PositionComponent(util.Vector2(position.x, position.y)))
          .addEntityComponent(polar, VelocityComponent(Vector2(0, 0), util.Vector2(velocity.x, velocity.y)))
          .addEntityComponent(polar, CollisionComponent(4, false, 0,Vector2(0,0)))
