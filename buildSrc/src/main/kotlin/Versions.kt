object Versions {
    ...
    // OLD const val ikonli = "2.4.0"
    const val ikonli = "11.5.0"
    const val enzo = "0.3.6"

    //SCALA_FX
    const val scalafx = "14-R19"
    const val scalafx_extras = "0.3.4"

    //SCALA
    const val scala_library = "2.13.3"
    const val junit = "4.12"

    //SCALATEST
    const val scalatest = "3.2.2"
    const val scalatest_plus = "3.2.2.0"
